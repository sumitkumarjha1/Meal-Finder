      ...
      <div className="meals" style={{ display: "flex", flexWrap: "wrap" }}>
        {contextInput.ingridients ? (
          contextInput.ingridients.map((element) => {
            return element ? (
              <div key={element.idMeal} className="meal"
              ...
              >
                <img src={element.strMealThumb} alt="#" style={{ width: "180px", height: "180px" }} />
            ...
            <div className="main">
              ...
              <ul>
                {ingrid.map((ele, index) => {
                  return (
                    <ListItem key={index} ele={ele} eleVal={ingridValue[index]} />
                  );
                })}
              </ul>
            </div>
